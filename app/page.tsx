  ...
  return (
    <main>
      ...
      <section className="contact-banner">
        <div className="section-shell contact-content"><div className="contact-copy"><p className="eyebrow">LET&apos;S TALK</p><h2>오스틴에서의<br /><em>다음 장을 시작해 볼까요?</em></h2><div className="contact-details"><a href="tel:+15129475599">512.947.5599</a><a href="mailto:kimsekyu@gmail.com">kimsekyu@gmail.com</a></div></div><figure className="contact-agent"><img src="https://pub-8ca6b7121e244bc5a6e95146a35297bf.r2.dev/legacy/wordpress/uploads/2023/07/%EA%B9%80%EC%84%B8%EA%B7%9C-%EB%B6%80%EB%8F%99%EC%82%B0-%EC%9C%A0%ED%8A%9C%EB%B8%8C-%EB%A1%9C%EA%B3%A0-%EC%82%AC%EC%A7%84-875x1024.jpg" alt="김세규 부동산" /><figcaption><strong>김세규 · REALTOR® / Broker</strong><span>2005년부터 풀타임으로 일해 온 텍사스 어스틴의 김세규에게 연락 주세요.</span></figcaption></figure></div>
      </section>
