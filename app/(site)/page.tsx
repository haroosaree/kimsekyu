...
const defaults = {
  ...
  contact: {
    eyebrow: "LET'S TALK", heading: "어스틴에서의\n다음 장을 시작해 볼까요?", emphasis: "", introduction: "어스틴 및 라운드락 인근 지역 (센트락 텍사스 지역) 의 각종 부동산 중개 서비스를 하고 있습니다. 김세규 부동산은 단독 주택, 타운홈, 다세대 주택, 상업용 부동산 (상가, 아파트, 대지, 오피스, 빌딩) 소개 및 매매, 렌트, 리스, 부동산 관리 등의 일을 합니다.", phone: "512.947.5599", email: "kimsekyu@gmail.com", profileName: "김세규 · REALTOR® / Broker", profileCaption: "2005년부터 풀타임으로 일해 온 텍사스 어스틴의 김세규에게 연락 주세요.",
